...
public class BattleBotArena extends JPanel implements MouseListener, MouseWheelListener, MouseMotionListener, ActionListener, Runnable {
     ...
     */
    public static final int RIGHT_EDGE = 1250;//1100; //ROWBOTTOM - changed from 700// also arena panel width
    /**
     * Bottom edge of the screen
     */
    public static final int BOTTOM_EDGE = 714;//714; //ROWBOTTOM - changed from 500// arena panel height is this constant + TEXT_BUFFER
    /**
     ...
     */
    public static final double     BULLET_SPEED = Math.floor(RIGHT_EDGE/200);//ROWBOTTTOM changed from 6 to accomodate larger screens
    /**
