...
public abstract class AbstBotHelper {
    ...
    public abstract double calcDisplacement(double botX, double bulletX);

    public abstract double calcDistance(double x1, double y1, double x2, double y2);

    //Call this as BotHelper.manhattanDist( , )
    public abstract double calcManhattanDist(double _dX, double _dY);

    //Call this as BotHelper.manhattanDist( , , , )
    public abstract double manhattanDist(double x1, double y1, double x2, double y2);

    public  abstract Bullet findClosest(BotInfo _me, Bullet[] _bullets);

    public  abstract BotInfo findClosest(BotInfo _me, BotInfo[] _bots);
}
